...
let MenuController = class MenuController {
    constructor() {
        this._service = new menu_service_1.MenuService();
    }
    ...
    async add(req, res) {
        let _response = { status: 200, data: [], message: 'Listando datos' };
        try {
            const body = req.body;
            const add = [...body];
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], MenuController.prototype, "deleteAll", null);
MenuController = __decorate([
    (0, controller_decorator_1.default)('/menu')
], MenuController);
